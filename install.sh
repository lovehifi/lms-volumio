...
select version in "8.4.0 Latest Release" "8.5.0 Development Build"; do
    case $version in
        ...
        8.5.0) wget https://downloads.slimdevices.com/nightly/logitechmediaserver_8.5.0~1709149164_all.deb -O /tmp/logitechmediaserver.deb; break;;
        *) echo "Invalid option";;
    esac
done
